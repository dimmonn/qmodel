...
public class DataPersistance {
    ...
    public List<ProjectAGraph> persistGraph(List<Project> repos, Map<Project, AGraph> ags) {
        ...
        for (Project repo : repos) {
            Optional<Project> foundProject = projectRepository.findById(new ProjectID(repo.getProjectOwner(), repo.getProjectName()));
    ...
    public Object persistActions(List<Project> projects, Map<Project, Actions> projectActionsMap) {
        Optional<Project> foundProject = projectRepository.findById(new ProjectID(projects.get(0).getProjectOwner(), projects.get(0).getProjectName()));
